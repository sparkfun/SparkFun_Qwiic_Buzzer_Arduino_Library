/**
 * @file    sfDevBuzzerPitches.h
 * @brief   Header file for SparkFun Qwiic Buzzer Library containing note definitions
 * @author  Pete Lewis \@SparkFun Electronics
 * @date    January 2024
 *
 * @note    Based on original source code written by Tom Igoe in Jan 2010:
 *          https://www.arduino.cc/en/Tutorial/BuiltInExamples/toneMelody
 *          http://www.arduino.cc/en/Tutorial/Tone
 *
 * @details This file contains a list of commonly found notes on a piano, defined
 *          as constants for use with the SparkFun Qwiic Buzzer Library.
 *
 *
